...
import type { BrandsApiBrandsGetData, BrandsApiBrandsGetResponses, GetPhoneBrandApiDeviceBrandGetData, GetPhoneBrandApiDeviceBrandGetResponses, GetPhoneBrandApiDeviceBrandGetErrors, ExportCsvApiExportCsvPostData, ExportCsvApiExportCsvPostResponses, TestApiTestGetData, TestApiTestGetResponses, TestSearchApiTestSearchPostData, TestSearchApiTestSearchPostResponses, TestSearchApiTestSearchPostErrors } from './types.gen';
 ...
 * Test Search
 */
export const testSearchApiTestSearchPost = <ThrowOnError extends boolean = false>(options: Options<TestSearchApiTestSearchPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TestSearchApiTestSearchPostResponses, TestSearchApiTestSearchPostErrors, ThrowOnError>({
        responseType: 'json',
        url: '/api/test_search',
        ...options
    });
