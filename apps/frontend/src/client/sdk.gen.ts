...
import type { BrandsApiBrandsGetData, BrandsApiBrandsGetResponses, GetPhoneBrandApiDeviceBrandGetData, GetPhoneBrandApiDeviceBrandGetResponses, GetPhoneBrandApiDeviceBrandGetErrors, ExportCsvApiExportCsvPostData, ExportCsvApiExportCsvPostResponses, TestApiTestGetData, TestApiTestGetResponses, SearchApiSearchPostData, SearchApiSearchPostResponses, SearchApiSearchPostErrors } from './types.gen';
 ...
 * Search
 */
export const searchApiSearchPost = <ThrowOnError extends boolean = false>(options: Options<SearchApiSearchPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SearchApiSearchPostResponses, SearchApiSearchPostErrors, ThrowOnError>({
        responseType: 'json',
        url: '/api/search',
        ...options
    });
